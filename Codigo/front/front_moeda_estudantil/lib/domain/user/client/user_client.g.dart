...
class _UserClient implements UserClient {
  ...
  @override
  Future<UserDTO> register(UserDTO req) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<UserDTO> update(UserDTO req) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<List<UserDTO>> getByType(String usuario) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'usuario': usuario};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<UserDTO>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/usuario/obterUsuariosPorTipoAcesso',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
